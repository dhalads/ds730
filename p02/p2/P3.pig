-- Problem 3
/*
There are 2 people that had unique heights. Who are they? You should output
their first and last names.

Hint

There isn’t much of a hint to give here. If you have the correct 2 people, it’s easy
to lookup their heights in the file and verify that no one else has the same height.
*/
