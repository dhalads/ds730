batters = LOAD 's3://halama1668/a03/t4/input/Batting.csv' using PigStorage(',');
...
names = LOAD 's3://halama1668/a03/t4/input/Master.csv' using PigStorage(',');
...
STORE sorted INTO 's3://halama1668/a03/t4/baseballsorted' USING PigStorage(',');