batters = LOAD 's3://BUCKET/InputFolder/Batting.csv' using PigStorage(',');
...
names = LOAD ' s3://BUCKET/InputFolder/Master.csv' using PigStorage(',');
...
STORE sorted INTO 's3://BUCKET/baseballsorted' USING PigStorage(',');